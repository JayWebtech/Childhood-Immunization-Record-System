		...
		<center>
			...
			<tr>
				...
				<td width="90%" style="padding: 10px;">
					...
					<br>
					<h3 align="center" style="color: #fff;font-family: Bold;">VIEW REGISTERED USERS</h3>
					<br>
					...
					<table width="100%" border="1" style="background-color: #fff;">
						...
						<tr>
							...
							<td style="font-weight: 600">EDIT</td>
							<td style="font-weight: 600">DELETE</td>
						</tr>
						<?php 
									$ftc = "SELECT * FROM users";									
						...
						<tr>
							...
							<td><a href="edit.php?id=<?php echo $rows['id']; ?>"><button class="btn btn-success btn-sm"><i class="glyphicon glyphicon-edit"></i> Edit</button></a></td>
							<td><a href="delete.php?id=<?php echo $rows['id']; ?>"><button class="btn btn-danger btn-sm"><i class="glyphicon glyphicon-trash"></i> Delete</button></a></td>
						</tr>
						<?php } ?>
					</table>
