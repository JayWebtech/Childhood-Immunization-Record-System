		...
		<center>
			...
			<tr>
				...
				<td width="90%" style="padding: 10px;background-color: #1CABE2">
					...
					<br>
					<h3 align="center" style="color: #fff;font-family: Bold;color: #000">VACCINATION BY LOCAL GOVERNMENT</h3>
					<br>

					<table width="100%" border="1" style="background-color: #fff;">

						<tr>
							<td style="font-weight: 600">LOCAL GOVERNMENT</td>
							<td style="font-weight: 600">VACCINATED</td>
						</tr>
						<?php 
									$ftc = "SELECT DISTINCT lga  FROM record";									
						...
						<tr>
							...
							<td>
								<?php
								$state = $rows['lga'];
									$stc = "SELECT COUNT(lga) AS total  FROM record WHERE lga = '$state'";	
