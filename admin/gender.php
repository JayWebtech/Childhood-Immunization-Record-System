		...
		<center>
			...
			<tr>
				...
				<td width="90%" style="padding: 10px;background-color: #1CABE2">
					...
					<br>
					<h3 align="center" style="color: #000;font-family: Bold;">VACCINATION BY GENDER</h3>
					<br>
					...
					<table width="100%" border="1" style="background-color: #fff;">
						...
						<?php 
									$ftc = "SELECT DISTINCT gender  FROM record";									
						...
						<tr>
							...
							<td>
								<?php
								$state = $rows['gender'];
									$stc = "SELECT COUNT(gender) AS total  FROM record WHERE gender = '$state'";	
